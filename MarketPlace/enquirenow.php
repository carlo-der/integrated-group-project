...
<body>
    ...
    function Darkmode() {
        var elements = document.querySelectorAll('.section-1, .section-2, .sidebar, .main-content, body, .listing-card, .listing-card p, .listing-card h3, .section-3, .Image, .container1, .contentbar');
